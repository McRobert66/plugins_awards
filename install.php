...
$description	=	"{[de]}Mit diesem Plugin könnt ihr eure Awards mit Slider und Page anzeigen lassen.{[it]}Con questo plugin è possibile visualizzare i premi con Slider e Page."; 	// description of the plugin
...
$sc_link 		=	"widget_awards";  					// sc_ file (visible as module/box)
...
$navi_link		=	"awards";					 		// navi link file (index.php?site=...)
$dashnavi_link	=	"admin_awards"; 					// dashboard_navigation link file

#@info: database
$install = "CREATE TABLE `" . PREFIX . "plugins_awards` (
...
$add_navigation = "INSERT INTO `".PREFIX."navigation_website_sub` (`mnavID`, `name`, `modulname`, `url`, `sort`, `indropdown`) 
					VALUES ('4','$navi_name', '$modulname', 'index.php?site=$navi_link', '1', '1');";
