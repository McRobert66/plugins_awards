...
if ($action == "new") {
    ...
    <div class="card-header">
                            <i class="fas fa-award"></i> ' . $plugin_language[ 'awards' ] . '
                        </div>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    if ($gesamt) {
      ...
      echo'<div class="card">
            <div class="card-header">
                            <i class="fas fa-award"></i> ' . $plugin_language[ 'award' ] . '</div>
            ...
            $rang = $ds[ 'rang' ];
                ...
                $adminaction =
                    ...
                    <input type="button" class="btn btn-danger" onclick="MM_confirm(
                            \'really delete this award?\',
                            \'admincenter.php?site=admin_awards&amp;delete=true&amp;awardID=' . $ds[ 'awardID' ] . '\'
                        )" value="' . $plugin_language[ 'delete' ] . '">';
